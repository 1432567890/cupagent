...
class LLMService:
    ...
    _SKILL_TRIGGERS: dict[str, tuple[str, ...]] = {
        ...
        "market-fees": (
            "комисси", "комиссия", "процент маркета", "процент площадки",
            "сколько берет", "сколько забирает", "fee", "fees", "commission",
            "сколько отходит", "сколько отрезает", "комис", "какая ставка",
        ),
        "currency-history": (
